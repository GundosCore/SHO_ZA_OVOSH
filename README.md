...
<p align="center">
  <em>SHO_ZA_OVOSH Локальная нейросеть на основе MobileNetV2 для распознавания 11 видов (на данный момент) овощей и фруктов</em>
</p>
<h4>На данный момент нейросеть распознаёт следующие виды растительных продуктов</h4>
<ul>
  <li>Апельсин</li>
  <li>Баклажан</li>
